...
export const PALETTES = [
...

  {
    ...
    emoji: "❤️",
        colors: [
        "#0B0C10", // חושך עמוק / מינימליזם
        "#141218", 
        "#1F1A24", 
        "#2B1F2D", 
        "#3D2235", // תחילת ההתעוררות של הלב
        "#522339", 
        "#6B233A", 
        "#852238", 
        "#A12033", // אדום עמוק
  ...
  },
  {
    ...
    iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle" font-size="18">🕊️</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#C0C0C0" text-anchor="end" stroke="rgba(0,0,0,0.5)" stroke-width="0.5" stroke-linejoin="round">HQ</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#C0C0C0" text-anchor="end">HQ</text></svg>',
  ...
  { 
    ...
    iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><path d="M13 2 L3 14 H12 L11 22 L21 10 H12 Z" fill="none" stroke="#00A3FF" stroke-width="1.5" stroke-linejoin="round"/><path d="M13 2 L3 14 H12 L11 22 L21 10 H12 Z" fill="#00376F" opacity="0.4"/><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#C0C0C0" text-anchor="end" stroke="rgba(0,0,0,0.5)" stroke-width="0.5" stroke-linejoin="round">HQ</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#C0C0C0" text-anchor="end">HQ</text></svg>',
  ...
  },
  {
    ...
    iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><path fill="#FFD700" d="M12 3 L22 20 L2 20 Z" /><path fill="#B8860B" d="M12 3 L22 20 L12 20 Z" /><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end" stroke="rgba(0,0,0,0.4)" stroke-width="0.5" stroke-linejoin="round">HD</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end">HD</text></svg>',
        colors: (function() {
  ...
  },
  {
    ...
    iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><defs><clipPath id="nrClip"><circle cx="12" cy="12" r="10.5"/></clipPath></defs><circle cx="12" cy="12" r="11" fill="#000000"/><g clip-path="url(#nrClip)" transform="rotate(-45 12 12)"><rect x="-5" y="3.75" width="34" height="1.5" fill="#8c28dc"/><rect x="-5" y="6.75" width="34" height="1.5" fill="#00b4ff"/><rect x="-5" y="9.75" width="34" height="1.5" fill="#109664"/><rect x="-5" y="12.75" width="34" height="1.5" fill="#ffc800"/><rect x="-5" y="15.75" width="34" height="1.5" fill="#eb5a5a"/><rect x="-5" y="18.75" width="34" height="1.5" fill="#ff3296"/></g><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end" stroke="rgba(0,0,0,0.4)" stroke-width="0.5" stroke-linejoin="round">HD</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end">HD</text></svg>',
            colors: (function() {
...
iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><path d="M12 21 C 12 18 10 17 10 13 C 10 9 13 8 15 7" fill="none" stroke="#004000" stroke-width="1.5" stroke-linecap="round"/><circle cx="15" cy="7" r="2.5" fill="#E03C8A"/><circle cx="10" cy="10" r="2.5" fill="#6A0DAD"/><circle cx="5" cy="13" r="2" fill="#87CEEB"/><circle cx="12" cy="11" r="3" fill="#FCD116"/><circle cx="18" cy="11" r="2" fill="#FFAA00"/><circle cx="12" cy="11" r="1.5" fill="#6A0DAD"/><circle cx="11.5" cy="10" r="0.5" fill="#FFFFFF"/><circle cx="12.5" cy="10" r="0.5" fill="#FFFFFF"/><path d="M11 12 C 11 13, 13 13, 13 12" fill="none" stroke="#6A0DAD" stroke-width="1.2" stroke-linecap="round"/><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end" stroke="rgba(0,0,0,0.4)" stroke-width="0.5" stroke-linejoin="round">HD</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end">HD</text></svg>',
...
iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle" font-size="18">🌿</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end" stroke="rgba(0,0,0,0.4)" stroke-width="0.5" stroke-linejoin="round">HD</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end">HD</text></svg>',
...

  {
    ...
    isArchived: true,
    iconHTML: '<svg viewBox="0 0 24 24" style="width: var(--icon-size); height: var(--icon-size);"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle" font-size="18">🏺</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end" stroke="rgba(0,0,0,0.4)" stroke-width="0.5" stroke-linejoin="round">64</text><text x="23" y="5" font-family="sans-serif" font-size="6" font-weight="bold" fill="#FFD700" text-anchor="end">64</text></svg>',
                    colors: (function() {
