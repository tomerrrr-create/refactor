...
btnSimSettings: document.getElementById('btnSimSettings'),
...
turingFeedSlider: document.getElementById('turingFeedSlider'),
  turingFeedValue: document.getElementById('turingFeedValue'),
  turingKillSlider: document.getElementById('turingKillSlider'),
  turingKillValue: document.getElementById('turingKillValue'),
