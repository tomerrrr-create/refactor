...
{
        originalName: "Dark Abyss (99)",
        emoji: '🌒',
        colors: [
            // 1. אש עמוקה וחלודה (הכי חם: אדום יורד לאט, כחול תמיד 0)
            "#FF6000", "#F95D00", "#F45A00", "#EE5700", "#E95400", "#E35100", "#DE4E00", "#D84B00", "#D34800", "#CD4500", "#C84200", "#C23F00", "#BD3C00", "#B73900", "#B23600", "#AD3300", "#A73000", "#A22D00", "#9C2A00", "#972700", "#912400", "#8C2100", "#861E00", "#811B00", "#7B1800", "#761500", "#701200", "#6B0F00", "#650C00", "#600900", "#5A0600", "#550300", "#500000",
            
            // 2. התהום המסתורית (מעבר חשך: אדום דועך לאפס, כחול מטפס לאט. אין שחור טהור!)
            "#4E0002", "#4B0004", "#490006", "#460009", "#44000B", "#41000E", "#3F0010", "#3C0013", "#3A0015", "#380017", "#35001A", "#33001C", "#30001F", "#2E0021", "#2B0024", "#290026", "#270029", "#24002B", "#22002D", "#1F0030", "#1D0032", "#1A0035", "#180037", "#15003A", "#13003C", "#11003E", "#0E0041", "#0C0043", "#090046", "#070048", "#04004B", "#02004D", "#000050",
            
            // 3. קרח תהומות (הכי קר: אדום תמיד 0, כחול מטפס למקסימום עם נגיעות תכלת אפל)
            "#000052", "#000357", "#00065C", "#000962", "#000C67", "#000F6D", "#001272", "#001577", "#00187D", "#001B82", "#001E88", "#00218D", "#002492", "#002798", "#002A9D", "#002DA3", "#0030A8", "#0033AD", "#0036B3", "#0039B8", "#003CBE", "#003FC3", "#0042C8", "#0045CE", "#0048D3", "#004BD9", "#004EDE", "#0051E3", "#0054E9", "#0057EE", "#005AF4", "#005DF9", "#0060FF"
        ]
    },


{
        originalName: "Thermal Vision (99)",
        emoji: '🌡️',
        colors: [
            // 1. קיפאון מוחלט (שחור לכחול כהה)
            "#000000", "#00000d", "#00001a", "#000026", "#000033", "#000040", "#00004d", "#00005a", "#000066", "#000073", "#000080",
            
            // 2. קור עז (כחול כהה לכחול בוהק)
            "#00008c", "#000099", "#0000a6", "#0000b3", "#0000bf", "#0000cc", "#0000d9", "#0000e6", "#0000f2", "#0000ff",
            
            // 3. התחממות קלה (כחול בוהק לסגול/אינדיגו)
            "#1a00ff", "#3300ff", "#4d00ff", "#6600ff", "#8000ff", "#9900ff", "#b300ff", "#cc00ff", "#e600ff", "#ff00ff",
            
            // 4. מעבר לחום (מג'נטה לוורוד-אדום)
            "#ff00e6", "#ff00cc", "#ff00b3", "#ff0099", "#ff0080", "#ff0066", "#ff004d", "#ff0033", "#ff001a", "#ff0000",
            
            // 5. חום בינוני (אדום טהור לאדום-כתום)
            "#ff0d00", "#ff1a00", "#ff2600", "#ff3300", "#ff4000", "#ff4d00", "#ff5a00", "#ff6600", "#ff7300", "#ff8000",
            
            // 6. חם מאוד (כתום לכתום-צהוב)
            "#ff8c00", "#ff9900", "#ffa600", "#ffb300", "#ffbf00", "#ffcc00", "#ffd900", "#ffe600", "#fff200", "#ffff00",
            
            // 7. להט ופלזמה (צהוב ללבן בוהק)
            "#ffff1a", "#ffff33", "#ffff4d", "#ffff66", "#ffff80", "#ffff99", "#ffffb3", "#ffffcc", "#ffffe6", "#ffffff",
            
            // 8. הבזקי פלזמה עליונים (לבן טהור לסיום חלק)
