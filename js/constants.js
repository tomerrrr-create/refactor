...
{
        name: 'Thermal Vision (99)',
        colors: [
            // 1. האפס המוחלט (שחור לכחול עמוק)
            "#000000", "#00001a", "#000033", "#00004d", "#000066", "#000080", "#000099", "#0000b3", "#0000cc", "#0000e6", "#0000ff",
            
            // 2. קור עז (כחול לתכלת)
            "#001aff", "#0033ff", "#004dff", "#0066ff", "#0080ff", "#0099ff", "#00b3ff", "#00ccff", "#00e6ff", "#00ffff", "#00fff2",
            
            // 3. קריר (תכלת לירוק-מים)
            "#00ffe6", "#00ffd9", "#00ffcc", "#00ffbf", "#00ffb3", "#00ffa6", "#00ff99", "#00ff8c", "#00ff80", "#00ff73", "#00ff66",
            
            // 4. טמפרטורת חדר (ירוק-מים לירוק טהור)
            "#00ff59", "#00ff4d", "#00ff40", "#00ff33", "#00ff26", "#00ff1a", "#00ff0d", "#00ff00", "#0dff00", "#1aff00", "#26ff00",
            
            // 5. התחממות (ירוק לירוק-צהבהב)
            "#33ff00", "#40ff00", "#4dff00", "#59ff00", "#66ff00", "#73ff00", "#80ff00", "#8cff00", "#99ff00", "#a6ff00", "#b3ff00",
            
            // 6. חמים (צהוב לכתום בהיר)
            "#bfff00", "#ccff00", "#d9ff00", "#e6ff00", "#f2ff00", "#ffff00", "#ffeb00", "#ffd600", "#ffc200", "#ffad00", "#ff9900",
            
            // 7. אש חמה (כתום לאדום)
            "#ff8500", "#ff7000", "#ff5c00", "#ff4700", "#ff3300", "#ff1f00", "#ff0a00", "#f50000", "#e00000", "#cc0000", "#b80000",
            
            // 8. לוהט (אדום כהה לסגול עמוק)
            "#a30000", "#8f0000", "#7a0000", "#660000", "#7a0029", "#8f0052", "#a3007a", "#b800a3", "#cc00cc", "#e000e0", "#ff00ff",
            
            // 9. ליבת פלזמה (סגול דרך ורוד זוהר ללבן)
            "#ff1aff", "#ff33ff", "#ff4dff", "#ff66ff", "#ff80ff", "#ff99ff", "#ffb3ff", "#ffccff", "#ffe6ff", "#fff2ff", "#ffffff"
        ]
},
