...

{
  ...
  colors: ["#000000","#424242","#7B1FA2","#5E35B1","#673AB7","#9C27B0","#C2185B","#E91E63","#FF1744","#C62828","#D32F2F","#3F51B5","#1976D2","#2196F3","#42A5F5","#0097A7","#00BCD4","#4CAF50","#66BB6A","#FF5722","#FFA726","#FFC107","#BDBDBD"]
...

    {
        ...
        emoji: '🇮🇱',
        colors: [
"#001F3F",   // כחול כהה עמוק
    "#003087",   // כחול ישראלי קלאסי
    "#005EB8",   // כחול בוהק
    "#0077E6",   // כחול בהיר
    "#40A9FF",   // תכלת שמיים
    "#A3D8FF",   // תכלת עדינה
    "#E6F0FF",   // לבן-כחול בהיר
    "#F5F8FF",   // לבן נקי
    "#FFFFFF",   // לבן טהור
    "#FFD700",   // זהב קלאסי (מגן דוד)
    "#FFCC00",   // זהב חם
    "#FFB300",   // כתום-זהוב
    "#E67E22",   // כתום מדבר
    "#2E8B57",   // ירוק ארץ ישראל
    "#3CB371",   // ירוק בהיר
    "#66C76F",   // ירוק חקלאי
    "#98E0A0",   // ירוק עדין (חדש)
    "#C8102E",   // אדום ישראלי חזק
    "#E31C3D",   // אדום בוהק
    "#8B0000",   // בורגונדי כהה
    "#2C2C2C",   // שחור-אפור כהה
    "#5A5A5A",   // אפור כהה
    "#B0B0B0"    // אפור בהיר (חדש)        
    ]
      },
{
...

{
    ...
    colors: [
        "#010005", "#05010F", "#0A021A", "#100426", "#170836", "#200D49", 
        "#2E1560", "#401F7A", "#FF4500", "#FF8C00", "#FFD700", "#FFFACD", 
        "#FFFFFF", "#F8F8FF", "#B0E0E6", "#00BFFF", "#1E90FF", "#DDA0DD", 
        "#BA55D3", "#8A2BE2", "#4B0082", "#2F0B45", "#1A0529", "#0B0114"
    ]
},
...

{
    ...
    emoji: '🍃',
    colors: [
        "#051810", "#0A241A", "#103225", "#184131", "#21523E", "#2B634D", 
        "#37765D", "#43896D", "#519D7E", "#60B290", "#71C7A3", "#83DDB6", 
        "#99F0CC", "#B3F7DD", "#CCFBEB", "#E3FDF4", "#F4FFFC", "#E0F4F4", 
        "#C6E6E6", "#A8D6D6", "#87C3C3", "#65AEAE", "#449797", "#247E7E"
    ]
},
